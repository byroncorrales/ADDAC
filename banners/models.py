...
class Banner(models.Model):
    ...
    imagen = ImageWithThumbsField(upload_to=get_image_path, sizes=((540,275),),help_text="Resolución 570x310")
    miniatura = ImageWithThumbsField(upload_to=get_image_path, sizes=((69,51),), help_text="Resolución 80x80")
