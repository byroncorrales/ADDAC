...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Publicacion.cidoc'
        db.alter_column('publicaciones_publicacion', 'cidoc', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Publicacion.cidoc'
        db.alter_column('publicaciones_publicacion', 'cidoc', self.gf('django.db.models.fields.BooleanField')())


    models = {
        'publicaciones.publicacion': {
            'Meta': {'object_name': 'Publicacion'},
            'cidoc': ('django.db.models.fields.IntegerField', [], {}),
